Zoomer Analytics GmbH End User License Agreement
...
1.2.	Authorized Developer means named individual users who write source code based on one or more Software products mentioned on the Order Form. As an example, this includes users who write code based on xlwings PRO or xlwings REPORTS.
1.3.	Authorized User means named individual users who use one or more Software products mentioned on the Order Form as end users without changing source code. As an example, this includes users of xltrail or users of deployed tools based on xlwings PRO or xlwings REPORTS.
